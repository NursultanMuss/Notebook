...
//        fab_plus = (FloatingActionButton) findViewById(R.id.fab_plus);
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Note, NotesAdapter.NotesViewHolder> firebaseRecyclerAdapter
                =new FirebaseRecyclerAdapter<Note, NotesAdapter.NotesViewHolder>() {
            @Override
            protected void onBindViewHolder(@androidx.annotation.NonNull NotesAdapter.NotesViewHolder holder, int position, @androidx.annotation.NonNull Note model) {

            }

            @androidx.annotation.NonNull
            @Override
            public NotesAdapter.NotesViewHolder onCreateViewHolder(@androidx.annotation.NonNull ViewGroup parent, int viewType) {
                return null;
            }
        }
    }
